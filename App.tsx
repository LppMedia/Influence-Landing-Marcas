...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-24 bg-[#05010a] text-white border-y border-white/5 overflow-hidden">
      ...
      <footer className="py-20 border-t border-white/10 bg-brand-dark/80 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6">
                <a href="https://www.instagram.com/lpp.media/" target="_blank" rel="noopener noreferrer" className="p-2 glass rounded-lg text-slate-400 hover:text-brand-magenta transition-colors shadow-sm flex items-center justify-center">
                  <iconify-icon icon="simple-icons:instagram" class="text-xl"></iconify-icon>
                </a>
                <a href="https://www.tiktok.com/@lpp.media" target="_blank" rel="noopener noreferrer" className="p-2 glass rounded-lg text-slate-400 hover:text-brand-magenta transition-colors shadow-sm flex items-center justify-center">
                  <iconify-icon icon="simple-icons:tiktok" class="text-xl"></iconify-icon>
                </a>
                <a href="https://www.linkedin.com/company/lpp-media-influence/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="p-2 glass rounded-lg text-slate-400 hover:text-brand-magenta transition-colors shadow-sm flex items-center justify-center">
                  <iconify-icon icon="simple-icons:linkedin" class="text-xl"></iconify-icon>
                </a>
                <a href="https://www.youtube.com/@LppMedia" target="_blank" rel="noopener noreferrer" className="p-2 glass rounded-lg text-slate-400 hover:text-brand-magenta transition-colors shadow-sm flex items-center justify-center">
