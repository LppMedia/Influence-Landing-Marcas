...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'iconify-icon': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & { icon?: string; class?: string }, HTMLElement>;
    }
  }
  namespace React {
    namespace JSX {
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative">
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'glass py-3 shadow-2xl' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <a 
            ...
            className="btn-shiny bg-brand-magenta text-white px-7 py-3 rounded-full text-sm font-black hover:brightness-110 transition-all shadow-[0_0_20px_rgba(208,24,253,0.3)] hover:shadow-[0_0_30px_rgba(208,24,253,0.5)] active:scale-95 flex items-center justify-center min-w-[200px] text-center"
          >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-5xl lg:text-8xl font-extrabold text-white leading-[1.05] mb-10 tracking-tight">
              Marketing con influencers que impulsa <br/>
              ventas reales
            </h1>
            <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              Conectamos tu marca con <span className="text-brand-magenta font-bold">creadores verificados</span> y campañas enfocadas en performance, con reportes transparentes.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto bg-white text-black px-10 py-5 rounded-full font-black text-lg hover:bg-slate-200 transition-all shadow-2xl flex items-center justify-center gap-3 group active:scale-95"
              >
                Agendar demostración
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 relative">
            ...
            <div className="space-y-8 lg:pl-12">
              <div className="inline-block px-3 py-1 bg-brand-magenta/10 text-brand-magenta rounded-md text-[10px] font-black uppercase tracking-widest border border-brand-magenta/20">
                La Transformación
              </div>
              ...
              <div className="space-y-6 pt-4">
                <ul className="space-y-6">
                  <li className="flex items-center gap-4 group">
                    ...
                    <span className="text-slate-300 font-medium">Alcance masivo en días, no años.</span>
                  </li>
                  <li className="flex items-center gap-4 group">
                    <div className="w-6 h-6 rounded-full border border-brand-magenta/20 flex items-center justify-center group-hover:bg-brand-magenta/10 transition-colors">
                      <Check className="w-4 h-4 text-brand-magenta" />
                    </div>
                    <span className="text-slate-300 font-medium">Contenido generado por usuarios (UGC) auténtico.</span>
                  </li>
                  <li className="flex items-center gap-4 group">
                    <div className="w-6 h-6 rounded-full border border-brand-magenta/20 flex items-center justify-center group-hover:bg-brand-magenta/10 transition-colors">
                      <Check className="w-4 h-4 text-brand-magenta" />
                    </div>
                    <span className="text-slate-300 font-medium">Efecto 'bola de nieve' en algoritmos.</span>
                  </li>
                  <li className="flex items-center gap-4 group">
                    <div className="w-6 h-6 rounded-full border border-brand-magenta/20 flex items-center justify-center group-hover:bg-brand-magenta/10 transition-colors">
                      <Check className="w-4 h-4 text-brand-magenta" />
                    </div>
                    <span className="text-slate-300 font-medium">Comunidad real que interactúa y compra.</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section id="servicios" className="py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">Tecnología y experiencia humana para escalar tu marca.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            <div>
              ...
              <p className="text-slate-600 font-bold uppercase tracking-widest text-xs">Creadores en red</p>
            </div>
            <div>
              <div className="text-4xl lg:text-5xl font-black text-brand-magenta mb-2">{counts.campaigns.toLocaleString()}+</div>
              <p className="text-slate-600 font-bold uppercase tracking-widest text-xs">Campañas ejecutadas</p>
            </div>
            <div>
              <div className="text-4xl lg:text-5xl font-black text-brand-magenta mb-2">{counts.time}h</div>
              <p className="text-slate-600 font-bold uppercase tracking-widest text-xs">Tiempo de lanzamiento</p>
            </div>
            <div>
              ...
              <p className="text-slate-600 font-bold uppercase tracking-widest text-xs">Reportes en tiempo real</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="porque" className="py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-32">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">De la idea al ROI en 5 pasos estructurados y apilables.</p>
          </div>
          
          <ScrollStack 
            useWindowScroll={true} 
            itemDistance={isMobile ? 250 : 400} 
            baseScale={0.9} 
            itemScale={0.02} 
              ...
              <ScrollStackItem key={idx} itemClassName="max-w-4xl mx-auto w-full">
                <div className="w-full glass p-12 lg:p-20 rounded-[3rem] border-white/5 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-brand-magenta/5 rounded-2xl flex items-center justify-center mb-8 border border-white/5">
            ...
            {CASE_STUDIES.map((study, idx) => (
              <div key={idx} className="group glass rounded-2xl overflow-hidden border border-white/10 shadow-sm hover:shadow-brand-magenta/10 transition-all">
                <div className="h-64 overflow-hidden">
                  <img src={study.image} alt={study.industry} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-60 group-hover:opacity-100" />
                </div>
                <div className="p-8">
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-600">Enfoque</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="glass p-8 rounded-2xl hover:bg-white/5 transition-all border border-white/5">
                ...
                <p className="text-slate-400 text-lg mb-8 italic">"{t.text}"</p>
                <div>
      ...
      <section id="precios" className="py-32 bg-brand-dark/60 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
          ...
          <div className="space-y-4">
            {FAQ_ITEMS.map((item, idx) => (
              <div key={idx} className="glass rounded-2xl overflow-hidden transition-all border border-white/5">
                ...
                {openFaq === idx && (
                  <div className="px-8 pb-8 text-slate-500 leading-relaxed animate-in slide-in-from-top-4 duration-300">
                    {item.answer}
                  </div>
                )}
              </div>
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass rounded-[3rem] p-12 lg:p-24 text-center relative overflow-hidden border border-white/5">
            <div className="relative z-10">
