...
const CurvedLoop = ({
  ...
  // Si curveAmount es 0, es una línea recta perfecta
  const pathD = `M-100,50 Q670,${50 + curveAmount} 1540,50`;
  ...
  // Generamos suficientes repeticiones para que no haya huecos
  const totalText = useMemo(() => {
    if (!spacing) return text;
    const count = Math.ceil(3000 / spacing) + 2;
  ...
  return (
    ...
    >
      <svg className="curved-loop-svg" viewBox="0 0 1440 100">
        ...
        {ready && (
          <text xmlSpace="preserve" className={className} dominantBaseline="middle">
